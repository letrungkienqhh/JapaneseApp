...
interface FeartureProps{
    pageName:String,
    
    feartureList:Array<IFearture>

}
const Fearture = (props:FeartureProps )=> {
    const list:IFearture[] =props.feartureList
    return (
        <section className="bg-white dark:bg-gray-900">
        <div className="w-full px-5 py-6 my-8 mx-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16 max-w-7xl">
          <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">{props.pageName}</h1>
