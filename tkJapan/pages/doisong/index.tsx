        ...
        <div>
            ...
            <section className="w-full px-5 py-6 mx-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16 max-w-7xl mt-2 border-t-2 ">
                <div className="container mx-auto px-5 ">
                    <h1 className="md:text-3xl text-2xl font-bold text-gray-800">Đời sống</h1>
                    {props.err? 
                        <ErrorComponent/>:
...
export const getStaticProps:GetStaticProps = async (context) => {
        console.log("getStaticProps trong doi song")

        
        const res= await fetch(`http://localhost:1337/api/doisongs/`)
